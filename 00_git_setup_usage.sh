# Initialize a repository from existing code (Ex. Cbioportal)
# Add the files in your new local repository. This stages them for the first commit.
git init
# Initialized empty Git repository in /home/gjain/bin/projects/Cbioportal/.git/
...
git commit -m "Initial commit of Cbioportal"
...
curl -u 'gauravj49' https://api.github.com/user/repos -d '{"name":"Cbioportal"}'
git remote add origin https://github.com/gauravj49/Cbioportal.git
